<x-guest-layout>
    ...
    {{-- ✅ MODAL BUKU PANDUAN --}}
    <div id="guideModal" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 mb-4">
                                    Selamat datang di <strong>SAPA POSYANDU</strong>! Sebelum memulai, silakan lihat
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center justify-between mb-3">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-900">Panduan_SAPA_POSYANDU.pdf
                                                </p>
                                    ...
                                    <div class="relative w-full" style="height: 400px;">
                                        <iframe
                                            ...
                                            class="w-full h-full rounded border border-gray-300" allow="autoplay">
                                        </iframe>
                                    </div>
                                </div>
