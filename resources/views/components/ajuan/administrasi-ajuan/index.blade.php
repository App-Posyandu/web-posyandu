<x-guest-layout>
    <form method="POST" action="{{ route('ajuan.store.administrasi') }}" enctype="multipart/form-data">
        ...
        <div class="flex items-center justify-end mt-8 space-x-4">
            ...
            <button type="submit" class="inline-flex items-center px-8 py-2 bg-pink-500 border border-transparent rounded-md font-semibold text-sm text-white hover:bg-pink-600">Kirim</button>
        </div>
    </form>
</x-guest-layout>
