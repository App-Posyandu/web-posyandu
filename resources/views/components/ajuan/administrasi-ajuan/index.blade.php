            ...
            @foreach ($items as $key => $label)
                @if ($key === 'ktp')
                    <div>
                        ...
                        <div x-show="ktp_preview"
                            class="mt-2 w-full h-32 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-md">
                            <img :src="ktp_preview" class="max-h-full max-w-full object-contain" alt="Preview KTP">
                        </div>
                        @if ($userKtp)
                            <button type="button"
                ...
                @elseif ($key === 'kk')
                    <div>
                        ...
                        <div x-show="kk_preview"
                            class="mt-2 w-full h-32 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-md">
                            <img :src="kk_preview" class="max-h-full max-w-full object-contain" alt="Preview KK">
                        </div>
                        @if ($userKk)
                            <button type="button"
