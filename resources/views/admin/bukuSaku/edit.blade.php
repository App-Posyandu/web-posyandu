                        ...
                        <div class="space-y-4">
                            ...
                            <div x-data="{
                                ...
                                <div class="mt-2 w-full h-80 border-2 border-dashed border-gray-300 rounded-md">
                                    <iframe x-show="previewUrl" :src="previewUrl" width="100%" height="100%"
                                ...
                                <div class="mt-2">
                                    <label for="file" class="text-sm text-gray-700">Pilih file baru untuk mengganti
                                        (biarkan kosong jika tidak ingin diubah):</label>
