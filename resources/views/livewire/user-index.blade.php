            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div class="flex flex-col md:flex-row items-stretch md:items-center gap-2 w-full md:w-auto">
                    <a href="{{ route('admin.users.create') }}"
                        class="px-4 py-2 bg-pink-500 text-white rounded-md text-sm font-semibold hover:bg-pink-600 text-center">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-3 text-left font-medium text-gray-500 uppercase tracking-wide">No</th>
                            <th class="px-4 py-3 text-left font-medium text-gray-500 uppercase tracking-wide">Nama</th>
                            <th class="px-4 py-3 text-left font-medium text-gray-500 uppercase tracking-wide">Email & NIK</th>
                            <th class="px-4 py-3 text-left font-medium text-gray-500 uppercase tracking-wide">Role</th>
                                ...
                                <td class="px-4 py-3">
                                    <div class="grid grid-cols-2 md:flex md:flex-col gap-2 w-full">
                                        ...
                                        <a href="{{ route('admin.users.show', $user) }}"
                                            class="px-3 py-1 bg-blue-500 text-white rounded-md text-xs text-center hover:bg-blue-600">
                                            Detail
                                        </a>

                                        @if ($currentUser->role === 'admin')
                                            <a href="{{ route('admin.users.edit', $user) }}"
                                                class="px-3 py-1 bg-yellow-500 text-white rounded-md text-xs text-center hover:bg-yellow-600">
                                                Ubah
                                            </a>
                                        @endif
